...
**Examples - Method Steps**

![](images/MethSteps_Col_AG_ex.png){fig-align="center"}

![](images/MethSteps_col_HO_ex.png){fig-align="center"}

**Mandatory fields - Method Sets**
...
**Examples - Method Sets**

![](images/methSets_Col_AD_ex.png){fig-align="center"}

![](images/methSets_Col_EH_ex.png){fig-align="center"}

## Detailed Description

**Method Steps**

![](images/methSteps_col_AG.png){fig-align="center"}
...
2.  **Columns H to O**
    ...
    ![](images/methSteps_col_HO.png){fig-align="center"}
...
![](images/methSets_Col_AD.png){fig-align="center"}

![](images/methSets_Col_EH.png){fig-align="center"}
...
In this guide you will learn how to enter Measures into the Measures template. Each entry in this template represents a Measure. As described in <!--# title of document and link-->, a Measure is a "measurement or observation of any substance including a biological, physical or chemical substance". For further information regarding terms and the colour-coding of columns that you will see, please refer to the beginning of this guide ([1) How to use templates]) and <!--# link to  page with definitions -->
...
Below you will find the fields that are mandatory for this template. You will also find some defintion of terms and examples of entries of data, with the fields filled and colour-coded. A more detailed description of some of the key concepts can be found in the following section, "Detailed Description".
...
![](images/samples_col_AG_ex.png){fig-align="center"}

![](images/samples_col_HN_ex.png){fig-align="center"}

![](images/samples_col_OU_ex.png){fig-align="center"}

## Detailed Description

![](images/samples_col_AG.png){fig-align="center"}
...
2.  **Columns H to N**
    ...
    ![](images/samples_col_HN.png){fig-align="center"}
