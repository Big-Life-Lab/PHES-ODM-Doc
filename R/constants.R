...
parts_sheet_column_names$part_domain_ID_column_name <- "domainID"
parts_sheet_column_names$part_speciment_set_column_name <- "specimenSet"
parts_sheet_column_names$part_comp_set_column_name <- "compSet"
parts_sheet_column_names$part_group_ID_column_name <- "groupID"
parts_sheet_column_names$part_class_ID_column_name <- "classID"
parts_sheet_column_names$part_nomenclature_ID_column_name <- "nomenclatureID"
parts_sheet_column_names$part_ontology_reference_column_name <- "ontologyRef"
parts_sheet_column_names$part_cat_set_ID_column_name <- "catSetID"
parts_sheet_column_names$part_unit_set_ID_column_name <- "unitSetID"
parts_sheet_column_names$part_agg_scale_ID_column_name <- "aggScaleID"
parts_sheet_column_names$part_quality_set_ID_column_name <- "qualitySetID"
