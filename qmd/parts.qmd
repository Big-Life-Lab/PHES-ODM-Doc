...
parts_display_template <- '### {partLabel} {{ #{partID} }} 
      ...
      *Part Status:* {if (status %!=na% constants$status_is_active) glue::glue(\'**{status}**\') else status }. \\
...
parts_table <-
  parts_table[parts_table[[parts_sheet_column_names$part_status_column_name]] != constants$status_is_development, ]
