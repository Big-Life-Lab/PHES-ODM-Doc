...
for (part_row_index in seq_len(nrow(parts_table))) {
  ...
  parts_info_display_content <-
    glue::glue(
      ...
      *Unit Set ID:* <a href="/{part_unit_set_ID_location}.html#{part_unit_set_ID}">{part_unit_set_ID}</a> </br>
      *Aggregation Scale ID:* <a href="#{part_agg_scale_ID}">{part_agg_scale_ID}</a> </br>
      *Quality Set ID:* <a href="/{part_quality_set_ID_location}.html#{part_quality_set_ID}">{part_quality_set_ID}</a> </br>
