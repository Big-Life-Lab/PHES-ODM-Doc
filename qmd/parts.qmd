...
for (part_row_index in seq_len(nrow(parts_table))) {
  ...
  # Verify input
  verify_input(part_label, missing_warning("Part label", part_ID))
  verify_input(part_description, missing_warning("Part description", part_ID))
  verify_input(part_instruction, missing_warning("Part instruction", part_ID))
  verify_input(part_type, missing_warning("Part type", part_ID))
  verify_input(part_domain_ID, missing_warning("Part domain ID", part_ID))
  verify_input(part_speciment_set, missing_warning("Part speciment set", part_ID))
  verify_input(part_comp_set, missing_warning("Part comp set", part_ID))
  verify_input(part_group_ID, missing_warning("Part group ID", part_ID))
  verify_input(part_class_ID, missing_warning("Part class ID", part_ID))
  verify_input(part_nomenclature_ID, missing_warning("Part nomenclature ID", part_ID))
  verify_input(part_ontology_reference, missing_warning("Part ontology_reference", part_ID))
  verify_input(part_cat_set_ID, missing_warning("Part cat set ID", part_ID))
  verify_input(part_unit_set_ID, missing_warning("Part unit set ID", part_ID))
  verify_input(part_agg_scale_ID, missing_warning("Part agg scale ID", part_ID))
  verify_input(part_quality_set_ID, missing_warning("Part quality set ID", part_ID))
  verify_input(part_ref_link, missing_warning("Part ref link", part_ID))
  verify_input(part_data_type, missing_warning("Part data type", part_ID))
  verify_input(part_min_value, missing_warning("Part min value", part_ID))
  verify_input(part_max_value, missing_warning("Part max value", part_ID))
  verify_input(part_min_length, missing_warning("Part min length", part_ID))
  verify_input(part_max_length, missing_warning("Part max length", part_ID))
  verify_input(part_status, missing_warning("Part status", part_ID))
  verify_input(part_first_released, missing_warning("Part first released", part_ID))
  verify_input(part_last_updated, missing_warning("Part last updated", part_ID))
