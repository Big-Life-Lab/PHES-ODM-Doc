# Public Health and Environmental Surveillance Open Data Model (PHEA-ODM, or ODM) Documentation

*NOTE:* This documentation for PHES-ODM Version 2.0 is in the beta testing stage and so is still a work in progress. Please be aware that changes will occur regularly for the next few months. If there is something you'd like to see in the documentation that you cannot currently find, please please [create an issue on our GitHub repository](https://github.com/Big-Life-Lab/PHES-ODM) or post about it on [our Discourse page](https://odm.discourse.group/).

This documentation is intended to support the adoption and use of the ODM by data custodians and data generators working in the field of environmental surveillance, specifically looking at public health. The ODM is a data model that is designed to capture data and metadata related to surveillance and store it in a consistent, shareable form. The ODM teamm has also developed a suite of tools to support validation and cleaning of formatted data. 
...
- You test for biologic, chemical, and physical threats to human health.
