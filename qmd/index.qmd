...
> Make collecting and sharing high-quality, interoperable environmental surveillance data as easy as possible.

<!-- {{< include _dictionary-version.qmd >}}   -->

::: callout-warning
This documentation for the PHES-ODM Version 2.0.0 release candidate. Please be aware that changes will occur regularly in the next weeks. If there is something you'd like to see in the documentation that you cannot currently find, please please [create an issue on our GitHub repository](https://github.com/Big-Life-Lab/PHES-ODM) or post about it on [our Discourse page](https://odm.discourse.group/).
:::
