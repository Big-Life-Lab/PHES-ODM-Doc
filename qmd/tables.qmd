...
parts_table <- format_table(parts_table, table_name_columns, check_table_values = TRUE)
check_values_for_table(parts_table, all_table_column_names, c(constants$part_sheet_table_column_type_is_PK, constants$part_sheet_table_column_type_is_FK, constants$part_sheet_table_column_type_is_header))
