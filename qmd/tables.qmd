...
tables_data <- tables_data[order(tables_data[[parts_sheet_column_names$part_id]]),]
...
all_table_column_names <- tables_data[[parts_sheet_column_names$part_id]]
...
for (table_row_index in seq_len(nrow(tables_data))) {
  ...
  current_table_ID <- current_table_data[[parts_sheet_column_names$part_id]]
  ...
  current_table_label <- current_table_data[[parts_sheet_column_names$part_label]]
  current_table_description <- current_table_data[[parts_sheet_column_names$part_description]]
  current_table_instructions <- current_table_data[[parts_sheet_column_names$part_instruction]]
  ...
  part_label_label <- parts_table[parts_table[[parts_sheet_column_names$part_id]]== parts_sheet_column_names$part_label, parts_sheet_column_names$part_label]
  part_ID_label <- parts_table[parts_table[[parts_sheet_column_names$part_id]]== parts_sheet_column_names$part_id, parts_sheet_column_names$part_label]
  ...
  for (column_row_index in seq_len(nrow(table_columns))) {
    ...
    column_ID <- current_table_column[[parts_sheet_column_names$part_id]]
    
    # Variables being used in column display
    column_label <- current_table_column[[parts_sheet_column_names$part_label]]
    column_description <- current_table_column[[parts_sheet_column_names$part_description]]
    column_required <- current_table_column[[current_table_required_column_name]]
    column_dataType <- current_table_column[[parts_sheet_column_names$data_type]]
    ...
    if (column_dataType == parts$data_type$categories$categorical) {
      column_catSetID <- current_table_column[[parts_sheet_column_names$mma_set]]
      tables_info_display_content <- verify_and_append_content(
        tables_info_display_content,
        column_catSetID,
