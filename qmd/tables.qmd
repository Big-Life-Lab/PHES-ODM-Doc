...
tables_data <-
  parts_table[parts_table[[parts_sheet_column_names$part_type_column_name]] == constants$part_type_is_table &
                parts_table[[parts_sheet_column_names$part_status_column_name]] == constants$status_is_active,]
...
for (table_row_index in seq_len(nrow(tables_data))) {
  ...
  for (column_row_index in seq_len(nrow(table_columns))) {
    ...
    if (column_dataType == constants$data_type_is_categorical) {
