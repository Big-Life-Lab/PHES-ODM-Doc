...
for (row_index in seq_len(nrow(languages_table))) {
  ...
  lang_ID <- working_row[[languages_sheet_column_names$lang_ID]]
  
  nat_name <- working_row[[languages_sheet_column_names$nat_name]]
  lang_fam <- working_row[[languages_sheet_column_names$lang_fam]]
  lang_name <- working_row[[languages_sheet_column_names$lang_name]]
  code_1 <- working_row[[languages_sheet_column_names$iso6391]]
  code_2 <- working_row[[languages_sheet_column_names$iso6392B]]
  code_3 <- working_row[[languages_sheet_column_names$iso6392T]]
  code_4 <- working_row[[languages_sheet_column_names$iso6393]]
  code_5 <- working_row[[languages_sheet_column_names$iso6396]]
