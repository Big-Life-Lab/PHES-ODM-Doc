...
-   `samples` and `measures` tables are used day-to-day reporting. Information about a sample will be recorded in the `samples` table. Measurements are recorded in the `measures` table. A measure is 'measurement or observation of any substance including a biological, physical or chemical substance'.
